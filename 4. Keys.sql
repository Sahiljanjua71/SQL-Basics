...
-- CREATE TABLE Sample (Id INT AUTO_INCREMENT PRIMARY KEY); 
...
CREATE TABLE foreign_key (
    ...
    State VARCHAR(100),
    Pincode INT,
    CONSTRAINT fk_sample FOREIGN KEY (User_Id) REFERENCES sample(Serial_no) ON DELETE CASCADE
);

INSERT INTO foreign_key (user_id, street, city, state, pincode)
VALUES
